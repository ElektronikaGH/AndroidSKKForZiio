...
public class LatinKeyboardView extends KeyboardView {
	...
	static final int KEYCODE_MUSHROOM = -103;
	static final int KEYCODE_CURSOR_LEFT = -104;
	static final int KEYCODE_CURSOR_RIGHT = -105;
	static final int KEYCODE_CURSOR_LEFT_LONGPRESS = -106;
	static final int KEYCODE_CURSOR_RIGHT_LONGPRESS = -107;
	...
	protected boolean onLongPress(Key key) {
		...
		case KEYCODE_CURSOR_LEFT:
			kal.onKey(KEYCODE_CURSOR_LEFT_LONGPRESS, null);
			return true;
		case KEYCODE_CURSOR_RIGHT:
			kal.onKey(KEYCODE_CURSOR_RIGHT_LONGPRESS, null);
			return true;
		default:
			/*
